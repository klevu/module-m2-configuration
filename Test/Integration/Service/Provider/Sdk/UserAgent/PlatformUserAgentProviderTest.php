...
namespace Klevu\Configuration\Test\Integration\Service\Provider\Sdk\UserAgent;
...
class PlatformUserAgentProviderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = PlatformUserAgentProvider::class;
        $this->interfaceFqcn = ComposableUserAgentProviderInterface::class;
        $this->objectManager = Bootstrap::getObjectManager();
    }

    public function testExecute_ContainsProductName(): void
    {
        /** @var PlatformUserAgentProvider $platformUserAgentProvider */
        $platformUserAgentProvider = $this->objectManager->get(PlatformUserAgentProvider::class);

        $result = $platformUserAgentProvider->execute();

        $this->assertStringContainsString(
            needle: PlatformUserAgentProvider::PRODUCT_NAME,
            haystack: $result,
        );
    }
