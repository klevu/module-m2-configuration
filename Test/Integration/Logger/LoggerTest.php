...
namespace Klevu\Configuration\Test\Integration\Logger;
...
/**
 * @covers ConfigurationLoggerVirtualType::class
...
class LoggerTest extends TestCase
{
    ...
    private const XML_PATH_LOG_LEVEL = 'klevu_configuration/developer/log_level_configuration';
    private const LOG_FILENAME_PATTERN = 'klevu-%s-configuration.log';
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = ConfigurationLoggerVirtualType::class; // @phpstan-ignore-line virtualType
